    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4 my-auth-forms">
            <label class="flex items-center">
                <input type="checkbox" id="accept_privacy" name="accept_privacy" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" required>
                <span class="ml-2 text-sm text-gray-600">
                    Ich akzeptiere die <a href="{{ route('datenschutz') }}" target="_blank" class="text-indigo-600 hover:text-indigo-800 underline">Datenschutzbestimmungen</a>
                </span>
            </label>
        </div>
        ...
        <div class="mt-4 my-auth-forms">
            <label class="flex items-center">
                <input type="checkbox" id="accept_terms" name="accept_terms" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" required>
                <span class="ml-2 text-sm text-gray-600">
        ...
        <div class="flex items-center justify-end mt-4 my-auth-forms">
            ...
            <button type="submit" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150 ms-3" id="register-button">
                Registrieren
            </button>
        </div>
    </form>
