            ...
            <div class="p-6 space-y-6">
                ...
                <form method="POST" action="{{ route('admin.headlines.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="headline_text" id="headline_text" rows="3" class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500 font-mono" required>{{ old('headline_text') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="subline_text" id="subline_text" rows="3" class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500 font-mono" required>{{ old('subline_text') }}</textarea>
