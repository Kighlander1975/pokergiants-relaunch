...
@section('title', 'Section erstellen')
            ...
            <div class="p-6 space-y-6">
                ...
                <form method="POST" action="{{ route('admin.sections.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="section_name" id="section_name" value="{{ old('section_name') }}" class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500" required>
